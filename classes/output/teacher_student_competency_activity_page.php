...
/**
 * Renderable class for teacher's view of student activity competency performance.
 *
...
/**
 * Class teacher_student_competency_activity_page
 *
 * @package    local_yetkinlik
 */
class teacher_student_competency_activity_page implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $export->has_activityrows = !empty($this->data->activityrows);
        $export->activityrows = $this->data->activityrows ?? [];
        $export->activitytotal = $this->data->activitytotal ?? null;

        // Genel Özet Aktarımı
        $export->overallsummary = $this->data->overallsummary ?? null;
