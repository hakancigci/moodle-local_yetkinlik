...
$string['ai_not_configured'] = 'AI is enabled but settings are incomplete.';
...
$string['arithmetic_mean_activities'] = 'Arithmetic Mean (General Activities)';
...
$string['compareinfo'] = 'In this report, you can compare your performance with the general course and your class.';
$string['competency'] = 'Competency / Learning Outcome';
$string['competencycode'] = 'Competency Code';
$string['competencyname'] = 'Outcome / Competency';
$string['competencyweights'] = 'Competency Weight Management';
$string['configureweights'] = 'Configure Competency Weights';
...
$string['evidence_description'] = 'Achievement for competency {$a->competency}: %{$a->rate}';
$string['evidence_description_detailed'] = 'Quiz Success: %{$a->quizrate}, Activity Average: %{$a->activityrate} (General Average: %{$a->rate})';
...
$string['evidence_lbl_quizrate'] = 'Quiz Success';
$string['evidence_note'] = 'Achievement for competency {$a->competency}: %{$a->rate}';
$string['exclude_item'] = 'Exclude';
...
$string['managecriteria'] = 'Define Competency Criteria';
...
$string['mode_score_by_average'] = 'Add Evidence + Score by Quiz Success and Other Activities Average';
$string['mode_score_by_question'] = 'Add Evidence + Score by Quiz Success Percentages';
...
$string['mycriteriaprogression'] = 'My Progression Criteria';
...
$string['no_direct_activities_found'] = 'No non-exam activities found related to this competency.';
...
$string['overallsummarytitle'] = 'Overall Competency Performance Summary (Quizzes + Activities Average)';
$string['pdfmystudent'] = '📄 View My PDF Report Card';
...
$string['process_queued'] = 'Success rate calculation task has been queued. It will be completed in the background.';
$string['process_success_desc'] = 'This process calculates students\' success percentages in quiz questions and adds them as evidence.';
...
$string['quiz'] = 'Quiz';
$string['quizperformances'] = 'Quiz Performances';
...
$string['selectcompetencylabel'] = 'Select Competency';
...
$string['show'] = 'Show';
$string['structured_blue'] = '{$a->shortname}: Success rate %{$a->rate}. Mostly learned. Recommendation: Review missing points.';
...
$string['studentpdfreport'] = 'Competency Progress Report';
$string['studentreport'] = 'My Competency Report Card';
...
$string['teachercompetencymenu'] = 'Competency Management & Reports';
$string['teachercompetencyoverview'] = 'Competency-Based Activity and Question Overview';
...
$string['weight_percentage'] = 'Weight Percentage (%)';
$string['weightmustbe100'] = 'The sum of weights must be exactly 100! Current total: {$a}';
$string['weightsavedsuccess'] = 'Weights successfully saved.';
$string['weightsavedsuccessfully'] = 'Weights successfully saved.';
$string['weighttotalerror'] = 'The total weight must be 100! Current total: {$a}';
$string['weighttotalwarning'] = 'The sum of weights must be exactly <strong>100</strong>. You can set the weight to 0 or check the exclude box for items you want to exclude.';
