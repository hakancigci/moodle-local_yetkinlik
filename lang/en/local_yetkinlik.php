...
$string['maxpercent'] = 'Maximum Percentage Threshold';
$string['maxrows'] = 'Maximum rows';
$string['maxrows_desc'] = 'Maximum number of rows to display in tables.';
$string['minpercent'] = 'Minimum Percentage Threshold';
$string['model'] = 'Model';
...
$string['noscaleitemsfound'] = 'No scale items found for the selected scale.';
