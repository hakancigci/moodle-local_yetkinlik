...
$string['activityprefix'] = 'Etkinlik';
...
$string['arithmetic_mean_activities'] = 'Aritmetik Ortalama (Etkinlikler Geneli)';
...
$string['competencyweights'] = 'Yetkinlik Ağırlık Yönetimi';
$string['configureweights'] = 'Yetkinlik Ağırlıklarını Yapılandır';
...
$string['evidence_description_detailed'] = 'Soru Başarısı: %{$a->quizrate}, Etkinlik Ortalaması: %{$a->activityrate} (Genel Ortalama: %{$a->rate})';
$string['evidence_lbl_activities'] = 'Etkinlikler';
$string['evidence_lbl_average'] = 'Başarı Kriteri Aritmetik Ortalaması';
$string['evidence_lbl_competency'] = 'Yetkinlik';
$string['evidence_lbl_quizrate'] = 'Soru Başarısı';
$string['evidence_note'] = 'Yetkinlik {$a->competency} için başarı: %{$a->rate}';
$string['exclude_item'] = 'Hariç Tut';
$string['filter'] = 'Filtrele';
$string['filterlabel'] = 'Filtrele';
$string['general_total_average'] = 'Genel Toplam / Ortalama';
...
$string['managecriteria'] = 'Yetkinlik Kriter Tanımlama';
$string['maxpercent'] = 'Üst Yüzde Sınırı';
$string['maxrows'] = 'Maksimum satır';
$string['maxrows_desc'] = 'Tablolarda görüntülenecek maksimum satır sayısı.';
$string['minpercent'] = 'Alt Yüzde Sınırı';
$string['model'] = 'Model';
$string['model_desc'] = 'Kullanılacak model adını girin (Örn: gpt-4).';
$string['mode_only_evidence'] = 'Sadece Kanıt Ekle';
$string['mode_score_by_average'] = 'Kanıt Ekle + Soru Başarısı ve Diğer Etkinliklerin Ortalamasına Göre Puanla';
$string['mode_score_by_question'] = 'Kanıt Ekle + Soru Başarı Yüzdelerine Göre Puanla';
...
$string['mycriteriaprogression'] = 'Gelişim Kriterlerim';
...
$string['noscaleitemsfound'] = 'Seçilen ölçeğe ait madde bulunamadı.';
$string['no_direct_activities_found'] = 'Bu yetkinliğe ait sınav dışı başka bir etkinlik bulunamadı.';
$string['orangelegend'] = 'Turuncu: Kısmen Kazanıldı (%40–59)';
$string['other_activities_related_title'] = 'Bu Yetkinlikle İlişkili Diğer Etkinlikler';
$string['overallsummarytitle'] = 'Genel Yetkinlik Performans Özeti (Sınavlar + Etkinlikler Ortalama)';
...
$string['quiz'] = 'Sınav';
$string['quizperformances'] = 'Soru Başarıları';
...
$string['scaleitem'] = 'Ölçek Maddesi (Seçenek)';
$string['scalemapping'] = 'Ölçek Yüzde Eşleme Yönetimi';
...
$string['selectcompetencylabel'] = 'Yetkinlik Seçin';
$string['selectgroup'] = 'Grup seçiniz';
$string['selectquiz'] = 'Sınav seçiniz';
$string['selectscale'] = 'Ölçek Seçin:';
...
$string['success_percentage'] = 'Başarı Yüzdesi';
...
$string['teachercompetencymenu'] = 'Yetkinlik Yönetimi ve Raporlar';
$string['teachercompetencyoverview'] = 'Yetkinlik Bazlı Etkinlik ve Soru Genel Görünümü';
$string['teacherstudentcompetency'] = 'Öğrenci Yetkinlik Analizi';
$string['teacherstudentcompetencyactivity'] = 'Öğrenci Yetkinlik Etkinlik Analizi';
...
$string['weight_percentage'] = 'Yüzde Ağırlığı (%)';
$string['weightmustbe100'] = 'Ağırlıklar toplamı tam olarak 100 olmalıdır! Mevcut toplam: {$a}';
$string['weightsavedsuccess'] = 'Ağırlıklar başarıyla kaydedildi.';
$string['weightsavedsuccessfully'] = 'Ağırlıklar başarıyla kaydedildi.';
$string['weighttotalerror'] = 'Ağırlıklar toplamı 100 olmalıdır! Mevcut toplam: {$a}';
$string['weighttotalwarning'] = 'Ağırlıkların toplamı tam olarak <strong>100</strong> olmalıdır. Hariç tutmak istediğiniz öğeler için ağırlığı 0 yapabilir veya hariç tut kutucuğunu işaretleyebilirsiniz.';
